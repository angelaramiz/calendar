...
- Known issues (updated Sep 2026):
  ...
  - JVM unit tests: `app/src/test/` (JUnit4); run `:app:testReleaseUnitTest --tests "<Clase>"`. `PatternExpanderTest` 9/9, `NotificationParserTest` 10/10, `MonthSummaryTest` 7/7, `FlowEngineTest` 13/13, `BudgetPlannerTest` 11/11, `GoalPlannerTest` 14/14 must stay green.
