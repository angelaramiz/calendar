...
- Known issues (updated Sep 2026):
  ...
  - JVM unit tests: `app/src/test/` (JUnit4); run `:app:testReleaseUnitTest --tests "<Clase>"`. `PatternExpanderTest` 9/9, `NotificationParserTest` 25/25, `MonthSummaryTest` 7/7, `FlowEngineTest` 21/21, `BudgetPlannerTest` 12/12, `GoalPlannerTest` 15/15, `PendingTxCodecTest` 8/8, `AuthErrorsTest` 8/8, `PatternValidatorTest` 7/7, `TransactionDayTest` 3/3 must stay green.
